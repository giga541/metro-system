...
//        schedule.addArrivalTime(LocalDateTime.now());
//        schedule.addDepartureTime(LocalDateTime.now().plusMinutes(30));
//        schedule.addTrain(train2);
//        schedule.addArrivalTime(LocalDateTime.now().plusHours(1));
//        schedule.addDepartureTime(LocalDateTime.now().plusHours(1).plusMinutes(30));
//
//        // Lines
//        Line line1 = new Line();
...
//        System.out.println("Train 1 arrival: " + schedule.getArrivalTimes().get(0));
//        System.out.println("Train 1 departure: " + schedule.getDepartureTimes().get(0));
//        System.out.println("Train 2 arrival: " + schedule.getArrivalTimes().get(1));
//        System.out.println("Train 2 departure: " + schedule.getDepartureTimes().get(1));
//        System.out.println("First train number: " + schedule.getTrains().get(0).getTrainNumber());

        Vehicle v1 = new Train(); // child 1
        Vehicle v2 = new Bus();   // child 2
        Booking booking = new Booking();

        booking.printVehicleType(v1);
        booking.printVehicleType(v2);
    }
}