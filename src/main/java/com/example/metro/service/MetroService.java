...
import main.java.com.example.metro.interfaces.PassengerAction;
import main.java.com.example.metro.interfaces.TicketValidator;
import main.java.com.example.metro.interfaces.TrainFilter;
...
public class MetroService {
    ...
    public double calculateTotalPrice(Passenger passenger, Ticket ticket) {
        BiFunction<Passenger, Ticket, Double> calculatePrice = (p, t) ->
                t.getAmount().doubleValue() * 1.1; // 10% main.java.com.example.metro.service fee
